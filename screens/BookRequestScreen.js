...
import {View,Text, TextInput, FlatList, TouchableHighlight,TouchableOpacity, Alert,StyleSheet,Modal, ScrollView, KeyboardAvoidingView,Image} from 'react-native';
...
export default class BookDonateScreen extends Component{
    ...
    addRequest = async (bookName,reasonToRequest)=>{
        ...
        var books=await BookSearch.searchbook(bookName,'AIzaSyCv3kcOY6WKUp0X2xdWwW78GJxpmdxCBGc')
